          ...
          >
            ...
            <template #tip>
              <div class="el-upload__tip">
                支持 JPG、PNG、JPEG、PDF 格式，单个文件不超过 20MB
              </div>
            </template>
          </el-upload>
          
          <el-form :model="form" label-width="90px" style="margin-top: 20px;" size="default">
            ...
            <el-form-item label="出差目的地">
              <el-input v-model="form.destination_city" placeholder="请输入城市名称" />
            </el-form-item>
              ...
              <template #header>
                <div class="card-header">
                  ...
                  <div class="status-badges">
                    <el-tag :type="getStatusType(result.status)" size="large" effect="dark">
...
import { UploadFilled, Check, Refresh, Document, CircleCloseFilled, WarningFilled } from '@element-plus/icons-vue'
